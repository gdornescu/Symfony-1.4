...
abstract class sfComponent
{
	 ...
	 * @ORM\Column(type="string")*@ORM\Column(type="string")*@ORM\Column(type="string")*@ORM\Column(type="string")*@ORM\Column(type="string")*@ORM\Column(type="string")*@ORM\Column(type="string")
	 */protected
    $moduleName             = '',
    $actionName             = '',
    $context                = null,
