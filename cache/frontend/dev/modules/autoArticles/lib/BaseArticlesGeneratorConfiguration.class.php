 ...
 */
abstract class BaseArticlesGeneratorConfiguration extends sfModelGeneratorConfiguration
{
  ...
  {
    return '%%id%% - %%category_id%% - %%user_id%% - %%title%% - %%body%% - %%image%% - %%created_at%% - %%updated_at%%';
  }
  ...
  {
    return array(  0 => 'id',  1 => 'category_id',  2 => 'user_id',  3 => 'title',  4 => 'body',  5 => 'image',  6 => 'created_at',  7 => 'updated_at',);
  }
